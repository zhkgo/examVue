    ...
    <div v-if="qType==1||qType==2||qType==3||qType==4||qType==5">
      ...
      <div v-else-if="qType==4" >
        ...
        <div v-if="answer.contentArray!==null">
          <el-form-item disabled :label="item.prefix" :key="item.prefix"  v-for="item in question.items"  label-width="50px" style="margin-top: 10px;margin-bottom: 10px;">
      ...
      <div v-else-if="qType==5">
        <div class="q-title" v-html="question.title"/>
        <div>
          <el-input disabled v-model="answer.content" type="textarea" rows="5" ></el-input>
        </div>
      </div>
