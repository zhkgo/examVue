  ...
  <div class="app-container">
    <el-form :model="queryParam" ref="queryForm" :inline="true">
      ...
      <el-form-item>
        ...
        <el-popover placement="bottom" trigger="click">
          <el-link target="_blank" :href="downloadUrl" style="margin-right:15px"><el-button type="warning" size="mini" >下载模板</el-button> </el-link>
          <el-button type="warning" size="mini"><el-upload action="/api/admin/upload/excel"  accept=".xlsx,.xls" :show-file-list="false"  :on-success="uploadSuccess">上传模板</el-upload></el-button>
          <el-button slot="reference" type="primary" class="link-left">模版导入</el-button>
        </el-popover>
      </el-form-item>
    </el-form>
...
export default {
  ...
  data () {
    return {
      ...
      tableData: [],
      total: 0,
      downloadUrl: 'https://exam-1252419034.cos.ap-shanghai.myqcloud.com/%E7%AE%A1%E7%90%86%E5%91%98%E9%A2%98%E7%9B%AE%E5%AF%BC%E5%85%A5%E6%A8%A1%E6%9D%BF.xlsx',
      questionShow: {
        qType: 0,
        dialog: false,
        question: null,
