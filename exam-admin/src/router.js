  ...
  },
  {
    ...
    children: [
      ...
      },
      {
        ...
        meta: { title: '学科添加', noCache: true, activeMenu: '/education/subject/list' },
        hidden: false
      }
    ]
  },
    ...
    children: [
      {
        ...
        name: 'AnswerPaperPageList',
        meta: { title: '批改列表', noCache: true }
      },
      {
        path: 'complete',
        component: () => import('@/views/exampaper/complete'),
        name: 'ExamPaperComplete',
        meta: { title: '完成列表', noCache: true },
        hidden: false
      },
      {
        path: 'edit',
        component: () => import('@/views/exampaper/edit'),
        name: 'ExamPaperEdit',
        meta: { title: '批改答卷', noCache: true },
        hidden: true
      },
      {
        path: 'read',
        component: () => import('@/views/exampaper/read'),
        name: 'ExamPaperRead',
        meta: { title: '查看答卷', noCache: true },
        hidden: true
      }
    ]
  },
