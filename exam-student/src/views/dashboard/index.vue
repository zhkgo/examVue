  ...
  <div style="margin-top: 10px">
    <el-row>
      <el-carousel :interval="5000" arrow="always" type="card">
        <el-carousel-item >
          <img src="@/assets/carousel/5.jpg" class="carousel-img">
        </el-carousel-item>
        <el-carousel-item >
          <img src="@/assets/carousel/6.jpg" class="carousel-img">
        </el-carousel-item>
        <el-carousel-item >
          <img src="@/assets/carousel/7.jpg" class="carousel-img">
        </el-carousel-item>
        <el-carousel-item >
          <img src="@/assets/carousel/8.jpg" class="carousel-img">
        </el-carousel-item>
      </el-carousel>
    </el-row>
        ...
        <el-col :span="4" v-for="(item, index) in timeLimitPaper" :key="index" :offset="index > 0 ? 1 : 0">
          <el-card :body-style="{ padding: '0px' }" v-loading="loading">
            ...
            <div style="padding: 14px;">
              ...
              <div class="bottom clearfix">
                <router-link target="_blank" :to="{path:'/do',query:{id:item.id}}" v-if="item.status === null">
                  <el-button type="text" class="button">开始做题</el-button>
                </router-link>
                <td width="70px">
                  <el-tag :type="statusTagFormatter(item.status)" v-if="item.status !== null" size="mini">
